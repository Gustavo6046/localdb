...
var BSON, BSONSerializer, DBSerializable, Database, DatabaseSerializer, GZIP, JSONSerializer, YAML, YAMLSerializer, _serTypes, abstractClass, compressions, fs, gzipped, isImplementation, zlib,
  indexOf = [].indexOf;
...
zlib = function(ser, compression) {
  var GZipped;
  GZipped = class GZipped {
    serialize(o) {
      return new Buffer(zlib[compressions[compression][0]](ser.prototype.serialize(o)));
    }

    deserialize(o) {
      return ser.prototype.deserialize(new Buffer(zlib[compressions[compression][1]](o)));
    }
