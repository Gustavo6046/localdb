...
var BSON, BSONSerializer, DBSerializable, Database, DatabaseSerializer, GZIP, JSONSerializer, YAML, YAMLSerializer, _serTypes, abstractClass, compressed, fs, gzipped, isImplementation, zlib,
  indexOf = [].indexOf;
...
compressed = function(ser, compression) {
  ...
  GZipped = class GZipped {
    serialize(o) {
      return new Buffer(zlib.deflate(ser.prototype.serialize(o), compression));
    }

    deserialize(o) {
      return ser.prototype.deserialize(new Buffer(zlib.inflate(o, compression)));
    }
