...
var DBSerializable, Database, DatabaseSerializer, JSONSerializer, SerializableFunction, YAML, YAMLSerializer, _serTypes, abstractClass, fs, isImplementation, ref,
...
SerializableFunction = (function(superClass) {
  extend(SerializableFunction, superClass);

  function SerializableFunction() {
    this.toObject = bind(this.toObject, this);
    return SerializableFunction.__super__.constructor.apply(this, arguments);
  }

  SerializableFunction.prototype.toObject = function() {
    var m;
    m = /function [a-zA-Z0-9\$_]+\(.+?\) {(.+)}/.match('' + this);
    return {
      name: this.name,
      args: this["arguments"],
      code: m[1]
  ...
  SerializableFunction.fromObject = function(o) {
    var ln, res;
    ln = o.args;
    ln.push(o.code);
    return res = Function.apply(this, ln);
  };

  SerializableFunction.fromFunc = function(func) {
